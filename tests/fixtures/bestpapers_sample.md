...
### Outstanding Papers 2026

* LLMs Get Lost In Multi-Turn Conversation (ICLR 2026) 
  [[Paper](https://openreview.net/forum?id=VKGTGGcwl6)]<br>
  *Authors: Philippe Laban, Hiroaki Hayashi, Yingbo Zhou, Jennifer Neville*

* Transformers are Inherently Succinct (ICLR 2026) 
  [[Paper](https://openreview.net/forum?id=Yxz92UuPLQ)]<br>
  *Authors: Pascal Bergsträßer, Ryan Cotterell, Anthony Widjaja Lin*

#### Outstanding Paper Honorable Mentions

* The Polar Express: Optimal Matrix Sign Methods and their Application to the Muon Algorithm (ICLR 2026) 
  [[Paper](https://openreview.net/forum?id=yRtgZ1K8hO)]<br>
...
* Efficiently Reconstructing Dynamic Scenes One D4RT at a Time (CVPR 2026) 
  [[Paper](https://arxiv.org/abs/2512.08924)]<br>
...
* Native and Compact Structured Latents for 3D Generation (CVPR 2026) 
  [[Paper](https://arxiv.org/abs/2512.14692)]<br>
...
* Spatially-Varying Autofocus (ICCV 2025) 
  [[Paper](https://openaccess.thecvf.com/content/ICCV2025/html/Qin_Spatially-Varying_Autofocus_ICCV_2025_paper.html)]<br>
